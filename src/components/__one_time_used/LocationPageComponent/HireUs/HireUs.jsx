...
const WhyHireUs = [
  ...
  },
  {
    ...
    description : "Choose a company that offers expertise in both pool design and construction."
  },
  {
    id : 3, 
    title : "Quality of Materials & Equipment",
    description : "Inquire about the quality of materials & equipment the company uses for pool."
  },
  {
    id : 4, 
    title : "Timelines and Project Management",
    description : "Make sure they can provide a clear timeline for the installation process."
  },
  {
    id : 5, 
    title : "Timelines and Project Management",
  ...
  },
  {
    ...
    description : "Get multiple quotes from different pool installer companies and compare their costs."
  },
  {
    id : 7, 
    title : "Communication and Customer Service",
    description : "Choose a company that is responsive, transparent, and willing to address concerns"
  }
]
