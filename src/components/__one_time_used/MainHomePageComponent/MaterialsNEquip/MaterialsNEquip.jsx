            ...
            <div className=" flex justify-center items-center md:pt-0 pt-[20px]">
              <div>
                ...
                <p className=" 2xl:text-[16px] md:text-sm text-sm 2xl:leading-[35px] lg:leading-[25px] leading-[20px] ">
                  ...
                  surrounding area. Equipment such as excavators, concrete
                  mixers, and pumps are essential for digging the hole, pouring
                  the concrete, and circulating water respectively. Pool liners,
