      ...
      <div className=" container">
        <div className=" grid md:grid-cols-7 grid-cols-1 gap-10 md:mx-0 mx-[35px] 2xl:py-[100px] lg:py-[70px] py-[50px]">
          ...
          <div className="md:col-span-4 ">
            ...
            <p className=" 2xl:text-[16px] md:text-[14px] text-[14px] 2xl:leading-[35px] lg:leading-[25px] leading-[20px] md:text-start text-center">
            ...
            <p className="mt-3 2xl:text-[16px] md:text-[14px] text-[14px] 2xl:leading-[35px] lg:leading-[25px] leading-[20px] md:text-start text-center">
