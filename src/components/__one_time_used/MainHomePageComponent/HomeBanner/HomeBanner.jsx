...
const HomeBanner = () => {
  return (
    <div className="container home-banner py-32 flex justify-center items-center">
      ...
      <Image
        src="/assets/images/home_banner.webp" // Use WebP for better performance
        layout="fill"
        objectFit="cover"
        priority={true} // Prioritize the loading of this image
        alt="Banner Image"
