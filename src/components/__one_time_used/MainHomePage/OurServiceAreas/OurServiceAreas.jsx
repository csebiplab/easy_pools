      ...
      <div className="">
        ...
        >
          <div className="mx-auto   flex flex-col items-center justify-center">
            ...
            <div>
              <h2 className='text-[25px] md:text-[27px] lg:text-[29px] xl:text-[32px] 2xl:text-[34px] 3xl:text-[36px] 4xl:text-[38px] 5xl:tex-[40px] font-bold text-black text-center leading-normal pt-[5px] pb-[10px]'>
                {bHeading}
              </h2>
            </div>
          </div>
