        ...
        <div className='full__section_r_p pl-3 md:pl-0 padding__top'>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-[36px]'>
                <div className='md:col-span-1'>
                    <Image src="/assets/homePage/Trusted.png" alt="trusted Partner" width={857} height={632} className='w-full h-[386px] xl:w-[857px] xl:h-[700px] 5xl:w-[857px] 5xl:h-[702px]'/>
                </div>
                <div className='md:col-span-1'>
