...
const QualityExcellence = () => {
  return (
    <div className="">
      <div className="bg_vinylPool full__section_l_p pr-3 md:pr-0 padding__top">
        <div className="grid md:grid-cols-6 grid-cols-1 gap-7">
          ...
          <div className="order-1 md:col-span-3 flex flex-col justify-center items-center md:items-start pt-6 md:pt-0">
            ...
            <p className="text-black text-lg font-normal mt-4 text-center md:text-left">
              ...
              aquatic indulgence. Imbued with meticulous craftsmanship, our
              vinyl pools reflect a commitment to durability and design that
              goes beyond expectations. Transform your outdoor space into a
              sanctuary of relaxation, where our company's vinyl wonders
              redefine the very essence of superior pool experiences. At our
              company, we understand that a pool is more than just a
              recreational space; it's a statement of your lifestyle. Our vinyl
              wonders epitomize this philosophy by seamlessly blending modern
              aesthetics with enduring quality. Step into a realm where each
              pool reflects our dedication to providing not just a{" "}
              <Link
                className="text-primary-600 hover:underline"
                href="https://en.wikipedia.org/wiki/Swimming"
              >
                swimming
              </Link>{" "}
              pool but an enduring piece of aquatic art that enhances the beauty
              of your home.
            </p>
          </div>
        </div>
