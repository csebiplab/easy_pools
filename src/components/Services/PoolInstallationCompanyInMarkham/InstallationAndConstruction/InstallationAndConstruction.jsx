      ...
      <div className="grid md:grid-cols-6 grid-cols-1 gap-5 xl:gap-6 3xl:gap-7 5xl:gap-[30px]">
        ...
        <div className="order-1 md:col-span-3 flex flex-col justify-center items-center md:items-start">
          ...
          <p className="text-lg font-normal text-center md:text-left text-black pt-[14px]">
            ...
            exceptional results. We understand that a swimming pool is not just
            a structure, but a centerpiece of leisure and relaxation for your
            home. That's why our Markham pool installers approach each project
            with meticulous attention to detail, ensuring that every aspect of
            the installation process is handled with care and expertise. Trust
            our Markham pool installation company to transform your backyard
            into a haven of tranquility and enjoyment.
          </p>
        </div>
      </div>
    </div>
