              ...
              <div className="pr-3 md:pr-0">
                {QAPoolInstallationQuestionsNAns.map((ques) => (
                  <Accordion key={ques?.id} open={open === ques?.id}>
                    ...
                    <AccordionBody className="py-3 pl-4 pr-8 lg:py-4 lg:px-6 5xl:py-5 5xl:px-7 border-2 text-black text-xs lg:text-sm 5xl:text-base font-normal 5xl:leading-[30px]">
                      {ques.answer}
                    </AccordionBody>
                  </Accordion>
                ))}
