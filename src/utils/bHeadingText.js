export const bHeadingTexts = {
    // our services area 
    fiberglassMap__bHeading: "Serving the Greater Toronto Horseshoe Area for all your pool's",
    hpeasyPoolsMap__bHeading:"Serving the Greater Toronto Horseshoe Area for all your pool's needs.",
