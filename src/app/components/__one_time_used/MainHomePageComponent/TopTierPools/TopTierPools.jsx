    ...
    return (
        <div className=' 
            ...
            <div className='bg-[#188B891A]'>
                <section className="overflow-hidden  container xs:px-[35px]  grid md:grid-cols-2 5xl:py-[70px] 3xl:py-[50px] py-[40px] ">
                    <div className="4xl:pr-[65px] pr-[45px] xs:order-2 md:order-1 text-center md:text-left">
                        ...
                        <div className="  ltr:sm:text-left rtl:sm:text-right">
                            ...
                            <p className='lg:text-[20px] md:text-[14px] xs:text-[10px]  '>
