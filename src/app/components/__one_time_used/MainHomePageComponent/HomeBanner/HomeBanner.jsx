...
//   return (
//     <div
//       className="bg-cover bg-center py-20 min-h-screen flex justify-center items-center"
//       style={{
//         backgroundImage: `url(${"/assets/images/banner_img.png"})`,
//       }}
//     >
//       <div className="text-center mix-blend-multiply bg-neutral-700 h-full w-full">
//         <div>
...
const HomeBanner = () => {
  return (
    <div className="home-banner py-20 min-h-screen flex justify-center items-center bg-blend-multiply bg-dark-200">
