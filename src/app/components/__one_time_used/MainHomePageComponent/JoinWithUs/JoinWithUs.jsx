        ...
        <div className=' '>
            <div className="bg-[#188B891A]">
                <div className=" custom-container md:px-0 xs:px-[35px] md:py-0 xs:py-10  grid grid-cols-1 md:grid-cols-8 gap-4">
                    ...
                    <div className=" md:col-span-4 md:order-1 bg-white  lg:px-8 px-4 lg:py-12 md:py-8 py-4  border-2 shadow-md md:rounded-xl xs:rounded-t-xl z-50 5xl:ml-[285px] 4xl:ml-[200px] 3xl:ml-[180px] 2xl:ml-[130px] xl:ml-[90px] lg:ml-[50px]
                    2xl:w-[770px] xl:w-[650px] lg:w-[600px] md:w-[500px] 2xl:h-[550px] xl:h-[500px] lg:h-[380px] md:h-[300px] md:my-10  3xl:my-[55px] lg:my-[25px] my-20px ">
                        ...
                        <div className=' flex justify-center items-center 2xl:mt-[50px] lg:mt-[25px] md:mt-[15px] mt-7'>
                            <Button title={"Get Your Estimate"}></Button> <p className='mx-5 text-[#049E43] xl:text-[18px] lg:text-[16px] md:text-[14px] text-[10px'>  or </p>
                            <p className=' xl:text-[18px] lg:text-[16px] md:text-[14px] text-[10px]  text-[#049E43]'> Call Us: 647-931-0164 </p>
                        </div>
