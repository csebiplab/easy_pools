                ...
                <div className=" col-span-1">
                  ...
                  <ul className=" ">
                    <li className=" ">
                      <Link
                        href="#"
                        className="footer-link lg:text-[20px] md:text-sm items-center text-white"
                      >
              ...
              <div className=" col-span-2 items-center">
                ...
                <ul className=" ">
                  <li>
                    <a
                      href=""
                      className="footer-link items-center lg:text-[20px] md:text-sm text-white"
                    >
      ...
      <div className="  footer-bottom-bg md:px-10 px-3  ">
        <div className="grid lg:grid-cols-9 md:grid-cols-2 gap-5 py-6  items-center container md:mx-auto ">
          ...
          <div className=" lg:col-span-4 md:col-span-1">
            <p className=" lg:text-[18px] md:text-sm  text-white">
